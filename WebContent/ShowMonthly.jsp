...
<div class="container1" >
   <div class="form-container sign-up-container">
      <form action="ShowMonthly2.jsp" method="post">
 <!-- Month<input type="month" name="eyear" placeholder="yyyy-mm">
<button>Submit</button> -->
        <center>
         <h1>Select Month</h1><hr>
         <!-- <span>or use your email for registration</span> -->
        <input type="text" name="email" value ="<%= email %>" readonly>
        <input type="month" name="eyear" placeholder="month" required/>
  <button>Submit</button>
