...
%></a>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h3 class="mb-5">
        <em>Here You Can See Monthly Expense</em>
      </h3>
...
String mo = request.getParameter("eyear");
%>
<h4><span class="blue"><!-- &lt; --></span>Month : 
<%  String[] arrmo = mo.split("-", 2); 
if(arrmo[1].equals("01"))
	 out.print("January " + arrmo[0]);
else if(arrmo[1].equals("02"))
	 out.print("February " + arrmo[0]);
else if(arrmo[1].equals("03"))
	 out.print("March " + arrmo[0]);
else if(arrmo[1].equals("04"))
	 out.print("April " + arrmo[0]);
else if(arrmo[1].equals("05"))
	 out.print("May " + arrmo[0]);
else if(arrmo[1].equals("06"))
	 out.print("June " + arrmo[0]);
else if(arrmo[1].equals("07"))
	 out.print("July " + arrmo[0]);
else if(arrmo[1].equals("08"))
	 out.print("August " + arrmo[0]);
else if(arrmo[1].equals("09"))
	 out.print("September " + arrmo[0]);
else if(arrmo[1].equals("10"))
 out.print("October " + arrmo[0]);
else if(arrmo[1].equals("11"))
	 out.print("November " + arrmo[0]);
else if(arrmo[1].equals("12"))
	 out.print("December " + arrmo[0]);
else
 out.print(mo);	
%>
<br><span class="blue"><span class="yellow">Monthly Expense List </span></h4>
<h2>This table show all your expenses <!-- <a href="http://pablogarciafernandez.com" target="_blank"> -->check each field<!-- </a> --></h2>
<%
try {
	Class.forName("com.mysql.jdbc.Driver");
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Expanse","root","1234");
	Statement statement = conn.createStatement();
	ResultSet result = statement.executeQuery("Select * from userentry where email='"+emaill+"' and edate like '"+mo+"-%'");
	%>
            ...
            data.addRows([
               ['Food', <%
            	   try {
            			...
            			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Expanse","root","1234");
            			Statement statement = conn.createStatement();
            			ResultSet result = statement.executeQuery("  SELECT SUM(eamt)from userentry where email='"+emaill+"' and edate like '"+mo+"-%' and efield='Food'");
...
//            			response.sendRedirect("Home.jsp");
               ...
               ['Education', <%
            	   try {
           			...
           			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Expanse","root","1234");
           			Statement statement = conn.createStatement();
           			ResultSet result = statement.executeQuery("  SELECT SUM(eamt)from userentry where email='"+emaill+"' and edate like '"+mo+"-%' and efield='Education'");
...
//           			response.sendRedirect("Home.jsp");
               ...
               ['Personal', <%
            	   try {
           			...
           			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Expanse","root","1234");
           			Statement statement = conn.createStatement();
           			ResultSet result = statement.executeQuery("  SELECT SUM(eamt)from userentry where email='"+emaill+"' and edate like '"+mo+"-%' and efield='Personal'");
...
//           			response.sendRedirect("Home.jsp");
               ...
               ['Others', <%
            	   try {
              			...
              			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Expanse","root","1234");
              			Statement statement = conn.createStatement();
              			ResultSet result = statement.executeQuery("  SELECT SUM(eamt)from userentry where email='"+emaill+"' and edate like '"+mo+"-%' and efield <> 'Food' and efield <> 'Education' and efield <> 'Personal' ");
