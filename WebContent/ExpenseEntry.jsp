...
<head>
  ...
  <title>New Expense Entry - Expense Entry</title>
...
%></a>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h3 class="mb-5">
        <em>Here  You Can Add New Expense</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">Click Here To Start</a>
    </div>
...
<div class="container1" >
   <div class="form-container sign-up-container">
      <form action="ExpenseEntry" method="post">
        <center>
         <h1>Add New Expense</h1><hr>
         <!-- <span>or use your email for registration</span> -->
        <input type="text" name="email" value ="<%= email %>" readonly>
        
   <input list="type" name="efield" placeholder="Efield" required/>
<datalist id="type" name="efield">
  <option value="Food" name="efield">
  <option value="Education" name="efield">
  <option value="Personal" name="efield">
  <option value="Other" name="efield">
</datalist>

<input type="text" name="eamt" placeholder="Eamount" required/>

<input type="date" name="edate" placeholder="Date :" required>

<input type="text" name="edes" placeholder="Description :" required><br>
